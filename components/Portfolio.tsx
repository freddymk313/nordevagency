        ...
        <div className="text-center mt-16">
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Rejoignez nos clients satisfaits et transformons ensemble vos idées en succès digital.
            </p>
            <button className="bg-gray-800 text-white px-8 py-3 rounded-lg hover:bg-gray-900 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl">
              Démarrer mon projet
            </button>
          </div>
        </div>
