      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <button className="border-2 text-sm border-[#111111] text-gray-800 px-8 py-4 rounded-full hover:border-gray-800 transition-all duration-300 font-semibold *text-lg hover:shadow-lg transform hover:-translate-y-1">
