...
const Hero = () => {
  return (
    <section id="home" className="min-h-[60vh] md:min-h-screen flex items-center justify-center relative overflow-hidden pt-12 md:pt-16">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center animate-fade-in"> 
          ...
          <p className="text-[16px] sm:text-lg md:text-xl lg:text-2xl text-gray-800 mb-6 md:mb-12 max-w-3xl mx-auto leading-relaxed">
            Chez <span className="font-semibold">Nordev Agency</span>, nous créons des sites web et applications mobiles 
            qui transforment votre vision en <span className="font-semibold text-black">solutions concrètes et performantes</span>.
          </p>
