...
const Testimonials = () => {
  const testimonials = [
    {
      quote:
        "Nordev Agency a complètement transformé notre présence digitale. Leur attention aux détails et leur expertise technique sont exceptionnelles. Notre nouveau site a augmenté les conversions de 150%.",
    ...
    {
      quote:
        "Travailler avec Nordev a été un tournant pour notre entreprise. Ils ont livré une application mobile qui a dépassé toutes nos attentes, et le support a été exceptionnel tout au long du processus.",
      author: "Michael Chen",
    ...
    {
      quote:
        "La créativité et le professionnalisme de l'équipe ont rendu tout le processus de développement fluide et agréable. Ils comprennent vraiment ce qu'il faut pour créer des produits digitaux exceptionnels.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-20">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
            Ils nous <span className="">font confiance</span>
          </h2>
          ...
          <p className="text-base text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            leurs{" "}
            <span className="">ambitions digitales en succès concrets</span>.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <blockquote className="text-gray-700 leading-relaxed text-base mb-6 italic relative">
                  "{testimonial.quote}"
                  <div className="absolute -top-2 -left-2 text-6xl text-gray-800/10 font-serif">
                    "
                  </div>
                </blockquote>
